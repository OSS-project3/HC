...
const legacyReviewImages: Record<string, string> = {
  "/images/cards/main%20sec1%20ex1.png": "/images/cards/width/kor-tiger-front.jpg",
...
const sampleReviewImages: Record<string, string> = {
  "review-1": "/images/cards/width/kor-tiger-front.jpg",
...
const initialReviews: ReviewPost[] = [
  { id: "review-1", title: "한국에서의 추억이 이름과 카드로 남았어요.", content: "이름의 뜻을 함께 설명해 주셔서 여행이 끝난 뒤에도 특별한 기억으로 간직하고 있습니다.", author: "윤은재", authorEmail: "sample1@example.com", createdAt: "2026-08-01", applicantType: "personal", cardType: "honorary-korean", imageUrl: "/images/cards/width/kor-tiger-front.jpg" },
