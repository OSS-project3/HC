...
| ⚪ | Application 도메인 엔티티/API 구현 착수 | Claude | `feature/application-domain-impl` | `docs/specs/application/api.md`, `docs/specs/application/requirements.md` | Codex 문서 작업 안정화 후 시작 여부 확인 필요 |
...
| ⚪ | lookup API 전화/이메일 인증 조합 확정 | 미정 | - | `docs/specs/application/api.md` | TBD |
| ⚪ | 단체신청 엑셀 실패율 처리 규칙 확정 | 미정 | - | `docs/specs/application/api.md` | TBD |
