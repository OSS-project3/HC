...
public class EventListItemResponse {
    ...
    public EventListItemResponse withTranslated(String title, String eventDateText, String place, String host,
            String content) {
        return new EventListItemResponse(id, eventType, title, eventDate, eventDateText, place, host,
                cardLabel, content, thumbnailImageUrl, company, logoUrl, displayOrder);
    }
}
