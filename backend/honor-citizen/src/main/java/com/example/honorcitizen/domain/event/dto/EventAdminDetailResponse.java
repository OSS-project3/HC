...
public class EventAdminDetailResponse {
    ...
    private EventAdminDetailResponse(Long id, EventType eventType, String title, LocalDate eventDate,
            ...
            String thumbnailImageUrl, String companyName, String logoImageUrl, boolean visible,
    ...
    public static EventAdminDetailResponse of(EventPost eventPost, String thumbnailImageUrl, String logoImageUrl,
        ...
        return new EventAdminDetailResponse(eventPost.getId(), eventPost.getEventType(), eventPost.getTitle(),
                ...
                logoImageUrl, eventPost.isVisible(), eventPost.getDisplayOrder(), images);
    }
}
