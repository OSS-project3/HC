...
public class EventDetailResponse {
    ...
    private EventDetailResponse(Long id, EventType eventType, String title, LocalDate eventDate,
            ...
            String thumbnailImageUrl, String company, String logoUrl, List<EventImageResponse> images) {
        this.id = id;
    ...
    public static EventDetailResponse of(EventPost eventPost, String thumbnailImageUrl, String logoUrl,
